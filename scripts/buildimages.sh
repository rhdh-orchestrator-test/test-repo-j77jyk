...
echo 'building image test-repo-j77jyk-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t test-repo-j77jyk-buildstage .
cd -

echo 'building image test-repo-j77jyk'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t test-repo-j77jyk .
cd -
